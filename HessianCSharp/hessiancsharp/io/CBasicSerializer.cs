                ...
                case INTEGER_ARRAY:
                    {
                        ...
                        int[] arrData = (int[])obj;
                        abstractHessianOutput.WriteListBegin(arrData.Length, "[int"); //$NON-NLS-1$
                ...
                case STRING_ARRAY:
                    {
                        ...
                        abstractHessianOutput.WriteListBegin(arrData.Length, "[string"); //$NON-NLS-1$
                        for (int i = 0; i < arrData.Length; i++)
                        {
                ...
                case BOOLEAN_ARRAY:
                    {
                        ...
                        abstractHessianOutput.WriteListBegin(arrData.Length, "[boolean"); //$NON-NLS-1$
                        for (int i = 0; i < arrData.Length; i++)
                ...
                case SBYTE_ARRAY:
                    {
                        ...
                        abstractHessianOutput.WriteListBegin(arrData.Length, "[sbyte"); //$NON-NLS-1$
                        for (int i = 0; i < arrData.Length; i++)
                            abstractHessianOutput.WriteInt(arrData[i]);
                        abstractHessianOutput.WriteListEnd();
                        break;
                ...
                case SHORT_ARRAY:
                    {
                        ...
                        abstractHessianOutput.WriteListBegin(arrData.Length, "[short"); //$NON-NLS-1$
                        for (int i = 0; i < arrData.Length; i++)
                            abstractHessianOutput.WriteInt(arrData[i]);
                        abstractHessianOutput.WriteListEnd();
                        break;
                ...
                case LONG_ARRAY:
                    {
                        ...
                        abstractHessianOutput.WriteListBegin(arrData.Length, "[long"); //$NON-NLS-1$
                        for (int i = 0; i < arrData.Length; i++)
                ...
                case FLOAT_ARRAY:
                    {
                        ...
                        abstractHessianOutput.WriteListBegin(arrData.Length, "[float"); //$NON-NLS-1$
                        for (int i = 0; i < arrData.Length; i++)
                ...
                case DOUBLE_ARRAY:
                    {
                        ...
                        abstractHessianOutput.WriteListBegin(arrData.Length, "[double"); //$NON-NLS-1$
                        for (int i = 0; i < arrData.Length; i++)
                            abstractHessianOutput.WriteDouble(arrData[i]);
                        abstractHessianOutput.WriteListEnd();
                        break;
                ...
                case OBJECT_ARRAY:
                    {
                        ...
                        abstractHessianOutput.WriteListBegin(arrData.Length, "[object"); //$NON-NLS-1$
                        for (int i = 0; i < arrData.Length; i++)
                        {
