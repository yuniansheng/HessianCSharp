...
namespace hessiancsharp.client
{
    ...
    public class CHessianProxyFactory
    {
        ...
        private IDictionary m_customHeaders;
        ...
        public CHessianProxyFactory(string username, string password, WebProxy webproxy, IDictionary customHeaders, bool defaultCredentials = false)
        {
            m_username = username;
            m_password = password;
            m_webproxy = webproxy;
            m_customHeaders = customHeaders;
            m_defaultCredentials = defaultCredentials;
        }
...
#else
            return new CHessianProxyStandardImpl(type, this, new Uri(strUrl), m_username, m_password, m_webproxy, m_customHeaders, m_defaultCredentials).GetTransparentProxy();
#endif
        }
